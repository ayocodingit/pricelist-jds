...
Hatur nuhun~ ✨`}
      ...
      <div className="w-full md:flex md:justify-center md:gap-5 max-h-[calc(85dvh)] md:h-full items-center overflow-auto md:overflow-hidden">
        ...
        <div className="p-3 flex flex-col gap-2 md:max-h-[calc(99dvh)] min-h-[calc(43dvh)] md:justify-center md:p-10 bg-white md:w-1/2 md:shadow-md md:rounded-md md:overflow-auto">
