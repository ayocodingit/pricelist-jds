    ...
    <div className="bg-gray-50 min-h-[calc(100dvh)]  flex md:justify-center">
      <div className="w-full md:w-1/2 flex flex-col relative">
        ...
        <div className="px-2 py-2 flex flex-col gap-3 bg-white justify-center">
          {products.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 h-[calc(75dvh)] p-2 overflow-auto">
          ...
          {products.length === 0 && (
            <div className="capitalize justify-center flex items-center h-[calc(50dvh)]">
