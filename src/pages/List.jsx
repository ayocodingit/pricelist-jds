...
<div className="flex flex-col px-5 gap-2 bg-white overflow-auto">
        ...
        <div className="flex flex-col gap-3 justify-center">
          {products.length > 0 && (
            <div className="grid bg-white  grid-cols-2 md:grid-cols-3 gap-2 h-[calc(60dvh)] md:min-h-[calc(60dvh)] p-2 overflow-auto">
          ...
          {products.length === 0 && !isLoading && (
            <div className="capitalize justify-center flex items-center h-[calc(60dvh)] md:min-h-[calc(60dvh)] overflow-auto">
