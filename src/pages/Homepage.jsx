  ...
  return (
    <div className="h-[calc(100dvh)] flex flex-col justify-center items-center gap-10 bg-gray-50">
      <div className="flex flex-col items-center   gap-2">
        <h1 className="text-4xl font-serif tracking-widest text-center"> JDS Mart </h1>
      </div>
      ...
      <div className="flex items-center flex-col gap-1">
        ...
        <Link
          className="w-40 h-8 text-center flex justify-center items-center rounded-lg border-2 text-white hover:bg-opacity-90 bg-primary "
          to={"list"}
        >
          Start
        </Link>
