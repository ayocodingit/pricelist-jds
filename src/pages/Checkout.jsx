...
Hatur nuhun~ ✨`);
  ...
  return (
    <div className="flex flex-col bg-gray-50 print:bg-white items-center w-full md:justify-center p-5 gap-4 relative print:justify-normal print:text-xs print:w-[55mm] print:font-extralight">
