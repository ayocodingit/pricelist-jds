...
function FilterCategory({ handleCategory, category }) {
  return (
    <>
      <li
        className={`p-2 gap-2 hover:cursor-pointer hover:opacity-90 flex flex-col items-center shadow-lg rounded-md bg-gray-50 ${
      ...
      >
        <img src="/hamburger.png" alt="food image" width={40} className={`${category == categoryOptions.FOOD ? 'grayscale-100' : 'grayscale'}`} />
      ...
      >
        <img src="/drink.png" alt="drink image" width={40} className={`${category == categoryOptions.DRINK ? 'grayscale-100' : 'grayscale'}`} />
